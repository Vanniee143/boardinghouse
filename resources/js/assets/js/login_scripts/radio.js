    ...
    document.querySelectorAll('input[name="userType"]').forEach(radio => {
        radio.addEventListener('change', function() {
            ...
            if (this.value === 'Admin') {
                window.location.href = 'admin_login.html';  // Redirect to admin_register.html
            } else if (this.value === 'Landlord') {
                window.location.href = 'landlord_login.html';  // Redirect to landlord_register.html
            } else if (this.value === 'Users') {
                window.location.href = 'login.html';  // Redirect to register.html
            }
        });
    });
